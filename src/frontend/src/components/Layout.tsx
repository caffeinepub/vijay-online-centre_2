              ...
              onError={(e) => {
                ...
                if (t.parentElement)
                  t.parentElement.innerHTML =
                    '<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:0.8rem;font-weight:800;color:oklch(0.78 0.12 85);background:oklch(0.22 0.06 240)">V</div>';
              }}
            />
          </div>
          <div>
            ...
            {isAdmin && (
              <span
                ...
                style={{
                  background: "oklch(0.78 0.12 85 / 20%)",
            ...
            {customerSession && !isAdmin && (
              <p
                ...
                style={{ color: "oklch(0.62 0.015 240)", fontSize: "0.65rem" }}
              >
                {customerSession.name !== customerSession.mobile
