  ...
  return (
    <div className="min-h-full page-enter" style={{ background: 'oklch(0.14 0.04 240)' }}>
      ...
      <div className="sticky top-0 z-10 px-4 pt-6 pb-4"
        ...
        <h1 className="text-xl font-bold mb-1" style={{ color: 'oklch(0.97 0.005 240)' }}>
          Our Services
        </h1>
        <p className="text-xs mb-4 font-devanagari" style={{ color: 'oklch(0.62 0.015 240)' }}>
      ...
      <div className="px-4 py-4 pb-24">
        {filteredServices.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="font-medium" style={{ color: 'oklch(0.62 0.015 240)' }}>No services found</p>
            <p className="text-sm mt-1" style={{ color: 'oklch(0.45 0.02 240)' }}>Try a different search term</p>
          </div>
        ) : (
            ...
            {filteredServices.map((service, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <ChevronRight size={16} style={{ color: 'oklch(0.45 0.02 240)' }} />
                </div>
              </button>
            ))}
          </div>
