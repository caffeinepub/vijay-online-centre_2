  ...
  return (
    <div className="min-h-screen flex flex-col navy-gradient">
      ...
      <div className="flex items-center px-4 pt-12 pb-6">
        ...
        <div>
          <h1 className="text-xl font-bold" style={{ color: 'oklch(0.97 0.005 240)' }}>Admin Login</h1>
          <p className="text-xs" style={{ color: 'oklch(0.72 0.015 240)' }}>Secure admin access</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 pb-16">
        ...
        <div className="flex justify-center mb-8">
          <div className="w-20 h-20 rounded-2xl flex items-center justify-center"
            style={{ background: 'oklch(0.22 0.06 240)', border: '2px solid oklch(0.78 0.12 85 / 40%)' }}>
