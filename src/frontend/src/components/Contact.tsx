  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="text-xs mt-1 font-devanagari"
      ...
      <div className="px-4 py-6 pb-24 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <a
            ...
            style={{
              ...
              border: "1px solid oklch(0.4 0.15 145 / 40%)",
            }}
          >
            <div
          ...
          <a
            ...
            className="flex items-center gap-4 p-4 rounded-2xl transition-all active:scale-95 w-full"
            style={{
              background: "oklch(0.6 0.15 200 / 15%)",
              border: "1px solid oklch(0.6 0.15 200 / 40%)",
            }}
          >
            <div
              className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
          ...
          <a
            ...
            className="flex items-center gap-4 p-4 rounded-2xl transition-all active:scale-95 w-full"
            style={{
              background: "oklch(0.65 0.15 27 / 15%)",
              border: "1px solid oklch(0.65 0.15 27 / 40%)",
            }}
          >
            <div
              className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
        ...
        >
          ...
          <p
            className="text-xs leading-relaxed font-devanagari"
            style={{ color: "oklch(0.72 0.015 240)" }}
          >
            सरकारी सेवाओं के लिए आपका विश्वसनीय डिजिटल केंद्र। हम आपकी सभी सरकारी
            दस्तावेज़ और ऑनलाइन सेवाओं में मदद करते हैं।
          </p>
          <p
            className="text-xs mt-2 leading-relaxed"
            style={{ color: "oklch(0.62 0.015 240)" }}
          >
            Your trusted digital centre for all government services and
            documentation.
          </p>
        </div>
