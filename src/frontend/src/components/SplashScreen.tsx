    ...
    <div className="fixed inset-0 flex flex-col items-center justify-center navy-gradient z-50 splash-fade">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.82 0.012 240), transparent)",
      ...
      <div className="relative mb-6 animate-scale-in">
        <div
          className="w-28 h-28 rounded-full flex items-center justify-center shadow-2xl overflow-hidden"
          style={{
            border: "3px solid oklch(0.78 0.12 85)",
        ...
        >
          <img
            ...
            onError={(e) => {
              ...
              if (parent) {
                parent.innerHTML =
                  '<span style="font-size:3rem;font-weight:800;color:oklch(0.78 0.12 85)">V</span>';
              }
            }}
          />
        </div>
      ...
      {/* App Name */}
      <h1
        className="text-3xl font-bold text-center mb-2 animate-fade-in"
        style={{ color: "oklch(0.97 0.005 240)", letterSpacing: "0.02em" }}
      >
        Vijay Online Centre
      </h1>
      <p
        className="text-sm font-medium mb-8 animate-fade-in"
      ...
      <div
        className="px-8 py-4 rounded-2xl text-center animate-fade-in mx-4"
        style={{
          background: "oklch(0.18 0.05 240 / 80%)",
          border: "1px solid oklch(0.35 0.08 240)",
        }}
      >
        <p
          className="text-lg font-semibold font-devanagari leading-relaxed"
