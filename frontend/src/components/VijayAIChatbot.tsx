  ...
  return (
    <>
      ...
      <button
        ...
        style={{
          background: 'linear-gradient(135deg, oklch(0.72 0.14 85), oklch(0.82 0.12 85))',
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-center gap-3 p-4"
            style={{ background: 'linear-gradient(135deg, oklch(0.18 0.05 240), oklch(0.22 0.06 240))', borderBottom: '1px solid oklch(0.28 0.07 240)' }}>
            <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0"
              style={{ background: 'linear-gradient(135deg, oklch(0.72 0.14 85), oklch(0.82 0.12 85))' }}>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-1">
                <div className="w-1.5 h-1.5 rounded-full pulse-dot" style={{ background: 'oklch(0.6 0.15 145)' }} />
                <p className="text-xs" style={{ color: 'oklch(0.62 0.015 240)' }}>24x7 Assistant</p>
              </div>
            </div>
            ...
            {messages.map((msg) => (
              <div key={msg.id} className={`flex ${msg.isBot ? 'justify-start' : 'justify-end'}`}>
                ...
                <div
                  ...
                  style={{
                    background: msg.isBot ? 'oklch(0.22 0.06 240)' : 'oklch(0.78 0.12 85)',
                    color: msg.isBot ? 'oklch(0.82 0.012 240)' : 'oklch(0.14 0.04 240)',
