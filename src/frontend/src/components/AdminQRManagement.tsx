...
export default function AdminQRManagement({ onBack }: AdminQRManagementProps) {
  ...
  const handleUploadQR = async () => {
    ...
    try {
      ...
      await setPermQRMutation.mutateAsync({
        base64,
        autoAmount: currentAutoAmount,
      });
  ...
  const handleSaveAmount = async () => {
    const parsed = Number.parseInt(autoAmount, 10);
    ...
    try {
      ...
      const msg =
        err instanceof Error
          ? err.message
          : "Failed to save amount. Please try again.";
      setAmountError(msg);
    }
  };
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl shadow-sm p-5">
                  ...
                  <button
                    ...
                    className="w-full border-2 border-dashed border-orange-300 rounded-xl p-6 text-center cursor-pointer hover:border-orange-400 hover:bg-orange-50 transition-colors mb-3"
                  >
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
                  <p className="text-xs text-orange-700">
                    <span className="font-semibold">Tip:</span> Upload your UPI
                    QR code image here. It will be shown to customers on the
                    payment screen. Keep the image clear and under 2MB for best
                    results.
                  </p>
                </div>
              </div>
